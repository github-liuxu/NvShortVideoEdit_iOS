...
typedef SWIFT_ENUM(NSInteger, MeicamMediaType, closed) {
...
typedef SWIFT_ENUM(NSInteger, NvFileSourceType, closed) {
...
typedef SWIFT_ENUM(NSInteger, NvProEditType, closed) {
  NvProEditTypeNone = 0,
...
typedef SWIFT_ENUM(NSInteger, NvSelectAssetType, closed) {
...
/// 与file关联文件的类型
typedef SWIFT_ENUM(NSInteger, NvSourceRelatedFileType, closed) {
...
SWIFT_CLASS("_TtC16NvShortVideoCore31NvTemplateMaterialCategoryModel")
@interface NvTemplateMaterialCategoryModel : NSObject
